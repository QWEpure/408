...
> 每次提问自动追加，用于统计薄弱知识点。新会话开头读此文件可恢复记录。
> 状态说明：🔴 待复习 | 🟡 基本理解需巩固 | 🟢 已掌握
...
- 每次你提问后，我会自动追加一条记录到「问题清单」并更新「统计概览」。
- 你可以随时说「XX 已掌握」或「XX 还不会」，我更新状态标记。
- 你可以随时说「给我看错题本」或「我哪些知识点最薄弱」，我据此分析。
